...
public class MainActivity extends AppCompatActivity {
    ...
    private void llenarPersonajes() {
        ...
        listaPersonajes.add(new PersonajeVo("Homer","Homer Jay Simpson es uno de los protagonistas de la serie. Es el padre de la familia protagonista y uno de los personajes centrales y más importantes de la serie.",R.drawable.homero));
