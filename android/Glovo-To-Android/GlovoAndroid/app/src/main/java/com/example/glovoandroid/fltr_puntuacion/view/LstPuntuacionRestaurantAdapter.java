...
public class LstPuntuacionRestaurantAdapter extends RecyclerView.Adapter<LstPuntuacionRestaurantAdapter.ViewHolder> {
    private ArrayList<Restaurante> dataset;
    private Context mContext;

    public LstPuntuacionRestaurantAdapter(Context mContext, ArrayList<Restaurante> lstPuntuacionRestaurantes){
        this.dataset = lstPuntuacionRestaurantes;
        this.mContext = mContext;
    }


    @Override
    public LstPuntuacionRestaurantAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_restaurant,parent,false);
        return new LstPuntuacionRestaurantAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LstPuntuacionRestaurantAdapter.ViewHolder holder, int position) {
