...
public class FiltrFichaDescriptivaAdapter extends RecyclerView.Adapter<FiltrFichaDescriptivaAdapter.ViewHolder> {
    private ArrayList<Restaurante> dataset;
    private Context mContext;

    public FiltrFichaDescriptivaAdapter(Context mContext, ArrayList<Restaurante> lstFichaRestaurantes){
        this.dataset = lstFichaRestaurantes;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_ficha_tecnica,parent,false);
