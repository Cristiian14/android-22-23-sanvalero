...
public class LstVentasRestaurantAdapter extends RecyclerView.Adapter<LstVentasRestaurantAdapter.ViewHolder> {
    private ArrayList<Restaurante> dataset;
    private Context mContext;

    public LstVentasRestaurantAdapter(Context mContext, ArrayList<Restaurante> lstVentasRestaurantes){
        this.dataset = lstVentasRestaurantes;
        this.mContext = mContext;
    }


    @Override
    public LstVentasRestaurantAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_restaurant,parent,false);
        return new LstVentasRestaurantAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LstVentasRestaurantAdapter.ViewHolder holder, int position) {
